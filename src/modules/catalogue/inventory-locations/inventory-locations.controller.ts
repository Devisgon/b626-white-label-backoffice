...
export class InventoryLocationsController {
  ...
  constructor(
    private readonly inventoryLocationsService:
  ...
  create(
    ...
    return this.inventoryLocationsService.create(
      createInventoryLocationDto,
    );
  ...
  findOne(
    ...
    return this.inventoryLocationsService.findOne(
      id,
    );
  ...
  remove(
    ...
    return this.inventoryLocationsService.remove(
      id,
    );
  ...
  restore(
    ...
    return this.inventoryLocationsService.restore(
      id,
    );
