...
export class ProductInventoryService {
  ...
  async create(
    ...
    const existing =
      await this.prisma.product_inventory.findUnique({
    ...
    if(existing){
      ...
      throw new ConflictException(
        ...
        'Product already assigned to this location',
  ...
  async findOne(
    ...
    const inventory =
      await this.prisma.product_inventory.findFirst({
  ...
  async getStats(){
    ...
    const total =
      await this.prisma.product_inventory.count({
